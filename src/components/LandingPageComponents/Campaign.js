  ...
  const objectives = [
    {
      ...
      title: "Raise funds to ensure no one goes untreated",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
      ...
      title: "Spread awareness to stop further propagation of disease",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
      ...
      title: "Unite everyone on the Thalassemia Crisis in Pakistan",
    },
  ];
  ...
  return (
    <div className="relative w-full bg-white min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-48">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-16 text-blue-500">
          Campaign Objective
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {objectives.map((objective, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-lg md:text-xl max-w-xs">
                {objective.title}
              </p>
            </div>
          ))}
